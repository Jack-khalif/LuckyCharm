...
const allProjects = [
  {
    ...
    impact: "Enhances public transport safety through real-time monitoring and emergency alerts",
    achievements: [
  ...
  },
  {
    ...
    impact: "Advancing ADHD diagnosis through explainable AI and clinical feature analysis",
    achievements: [
  ...
  },
  {
    ...
    description: "Reverse Osmosis water quality monitoring system with AI integration.",
    image: "/davisRO.png",
    icon: Droplets,
    ...
    impact: "Ensures water quality compliance through automated monitoring and analysis",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: "Machine learning model that predicts Formula 1 qualifying results.",
    image: "/F1.jpg",
    icon: TrendingUp,
    tags: ["Machine Learning", "Python", "Pandas", "Scikit-learn", "Sports Analytics"],
    status: "Active",
    ...
    impact: "Predicts F1 qualifying results with high accuracy using historical data",
  },
  {
    id: 6,
    title: "Clinical Decision Support AI",
    description: "AI-powered system that assists healthcare professionals in diagnosis and treatment planning.",
    image: "/akilidada.png",
    icon: Stethoscope,
  ...
  },
  {
    ...
    description: "High-performance data processing pipeline for genomic data analysis.",
    image: "/cancer.jpg",
    icon: Dna,
                ...
                >
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="flex gap-3">
                      <Button className="flex-1 group/btn transition-all duration-300 hover:scale-105" asChild>
              ...
              .map((project, index) => (
                ...
                >
                  ...
                  <CardContent className="p-6">
                    ...
                    {project.impact && <p className="text-sm text-slate-500 mb-6 italic">{project.impact}</p>}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto">
              Ready to transform industries through technology? Let's discuss your next innovative project.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-slate-400">© 2024 Jackson Mugwe. Transforming industries through technology.</p>
          </div>
        </div>
      </section>
    </div>
